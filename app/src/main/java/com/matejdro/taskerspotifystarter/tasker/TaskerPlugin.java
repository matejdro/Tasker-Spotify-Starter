package com.matejdro.taskerspotifystarter.tasker;
...
public class TaskerPlugin {
    ...
    public static String[] getRelevantVariableList(Bundle fromHostIntentExtras) {
        ...
        String[] relevantVars = (String[]) getBundleValueSafe(fromHostIntentExtras, BUNDLE_KEY_RELEVANT_VARIABLES,
                String[].class, "getRelevantVariableList");
        ...
        if (b != null) {
            if (b.containsKey(key)) {
                ...
                if (obj == null) {
                    ...
                    Log.w(TAG, funcName + ": " + key + ": expected " + expectedClass.getClass().getName() + ", got "
    ...
    public static class Setting {
        ...
        public static void requestTimeoutMS(Intent intentToHost, int timeoutMS) {
            if (timeoutMS < 0) {
                ...
                if (
                    ...
                    Log.w(TAG, "requestTimeoutMS: requested timeout " + timeoutMS + " exceeds maximum, setting to max" +
                            " (" + REQUESTED_TIMEOUT_MS_MAX + ")");
                    timeoutMS = REQUESTED_TIMEOUT_MS_MAX;
                }
        ...
        public static boolean signalFinish(Context context, Intent originalFireIntent, int resultCode, Bundle vars) {
            ...
            String completionIntentString = (String) getExtraValueSafe(originalFireIntent, Setting
                    .EXTRA_PLUGIN_COMPLETION_INTENT, String.class, "signalFinish");
        ...
        public static int getHintTimeoutMS(Bundle extrasFromHost) {
            ...
            Bundle hintsBundle = (Bundle) TaskerPlugin.getBundleValueSafe(extrasFromHost, EXTRA_HINTS_BUNDLE, Bundle
                    .class, "getHintTimeoutMS");

            if (hintsBundle != null) {

                Integer val = (Integer) getBundleValueSafe(hintsBundle, BUNDLE_KEY_HINT_TIMEOUT_MS, Integer.class,
                        "getHintTimeoutMS");
    ...
    public static class Event {
         ...
         *
         * @param requestQueryIntent intent being sent to the host
         * @return an ID for the bundle so it can be identified and the caller verified when it is again received by
         * the plugin
         * @see #hostSupportsRequestQueryDataPassThrough(Bundle)
         * @see #retrievePassThroughData(Intent)
         */
    ...
    public static class Host {
        ...
        public static int getSettingResultCode(Intent completionIntent) {
            ...
            Integer val = (Integer) getExtraValueSafe(completionIntent, Setting.EXTRA_RESULT_CODE, Integer.class,
        ...
        public static int getRequestedTimeoutMS(Bundle extrasFromPluginEditActivity) {
            return
                    (Integer) getBundleValueSafe(
                            extrasFromPluginEditActivity, Setting.EXTRA_REQUESTED_TIMEOUT, Integer.class,
                            "getRequestedTimeout"
                    )
                    ;
        }
